...
const Header = () => {
    return(
        <div className="flex flex-col md:flex-row flex-wrap bg-sky-600 rounded-lg px-6 md:px-10 lg:px-20">
            <div className="md:w-1/2 flex flex-col items-start justify-center gap-4 py-10 m-auto md:py-[10vw] md:mb-[-30px]">
                ...
                <div className="flex flex-col md:flex-row itmes-center gap-3 text-white text-sm font-light">
                    ...
                    <p>Simply browse through out extensive list of trusted doctors, 
                        <br className="hidden sm-block" /> schedule your appointments now.</p>
                </div>
